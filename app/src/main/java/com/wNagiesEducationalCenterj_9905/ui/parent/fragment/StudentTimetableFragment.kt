...
import com.wNagiesEducationalCenterj_9905.ui.adapter.TimetableAdapter
...
class StudentTimetableFragment : BaseFragment() {
    ...
    private fun downloadWithManager(
        ...
        if (path.exists()) {
            studentViewModel.saveDownloadFilePathToDb(id, path.absolutePath, DBEntities.TIME_TABLE)
            return downloadList
        }
