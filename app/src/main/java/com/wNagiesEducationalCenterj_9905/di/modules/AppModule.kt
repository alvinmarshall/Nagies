...
class AppModule {
    ...
    @Singleton
    @Provides
    fun providePreferenceProvider(sharedPreferences: SharedPreferences,application: Application): PreferenceProvider {
        return PreferenceProvider(sharedPreferences,application)
    }
