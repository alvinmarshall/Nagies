...
const val INFORDAS_BASE_URL =
    "http://192.168.8.101:81/api/"//"http://192.168.8.101:81/api/ --- http://nagiesportal.000webhostapp.com/api/"
const val DATABASE_NAME = "app_db"
const val LOGIN_PREF = "login_in_status"
const val USER_TOKEN = "user_token"
const val SERVER_URL =
    "http://192.168.8.101:81"//"http://192.168.8.101:81  --- http://nagiesportal.000webhostapp.com" ===https://nagies-portal.herokuapp.com
